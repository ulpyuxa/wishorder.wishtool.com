...
class AppSmarty extends Smarty{
	public function __construct(){
		...
		$this->compile_dir		= !defined('ENV') && ENV != 'local' ? 'saemc://smartytpl/' : WEB_PATH.'lib/smarty_sae/template_c/';
		$this->cache_dir		= !defined('ENV') && ENV != 'local' ? 'saemc://smartytpl/' : WEB_PATH.'lib/smarty_sae/cache/';
