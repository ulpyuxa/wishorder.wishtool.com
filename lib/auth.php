...
class Auth{
	...
	//private static $systemName = 'Power';//接口系统名称  类型：string	
	//private static $token      = 'dc1f5f11908695ca1d6d1a747929019d';//类型：string
	private static $systemName = 'Picture';//接口系统名称  类型：string	
	private static $token      = '1ffa3ceedd91ccb34e65339f9b1766c5';//类型：string
