...
class Pagination {
	 ...
	 * @return void 
	 */
	public function __construct($current = null, $total = null, $numPerPage = 10) {
		...
		$this -> _variables['rpp'] = $numPerPage;
	} 
	...
	public function addClasses($classes) {
		$this -> _variables['classes'] = array_merge($this -> _variables['classes'],
			(array) $classes
			);
	} 
	...
	public function getRelPrevNextLinkTags() {
		...
		$numberOfPages = (
			(int) ceil($this -> _variables['total'] / $this -> _variables['rpp']
				)
			); 
		// On first page
		if ($currentPage === 1) {
